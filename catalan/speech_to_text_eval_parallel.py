...
import torch
import transcribe_speech_parallel
...
@dataclass
class EvaluationConfig(transcribe_speech_parallel.ParallelTranscriptionConfig):
...
def main(cfg: EvaluationConfig):
    ...
    if not cfg.only_score_manifest:
        ...
        transcription_cfg = transcribe_speech_parallel.main(cfg)  # type: EvaluationConfig
