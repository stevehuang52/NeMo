...
#### Project Constants ####
PROJECT_NAME=ConformerL_ctc_catalan
DATASET=catalan
###########################
...
BUCKET_STRATEGY=fully_randomized  # synced_randomized
MAX_EPOCHS=1000
SAVE_TOP_K=10
LOG_PREDICTION=true
...
CONFIG_NAME=conformer_ctc_${ENCODING}
###############################
...
### Script to Run ###
SCRIPT_FILE="./examples/asr/asr_ctc/speech_to_text_ctc$SCRIPT_POSTFIX.py"
############################################################################################################
