...
def _modify_config(gpt_cfg, cfg, audio_cfg, add_cfg_to_tree=False):
    """
    ...
    with open_dict(gpt_cfg):
        ...
        gpt_cfg.target = f"{AudioGPTLoRAModel.__module__}.{AudioGPTLoRAModel.__name__}"
        gpt_cfg.audio_encoder = cfg.model.audio_encoder
        gpt_cfg.audio_encoder.preprocessor = audio_cfg.preprocessor
        gpt_cfg.audio_encoder.encoder = audio_cfg.encoder
...
def main(cfg) -> None:
    ...
    model_cfg = _modify_config(base_model_cfg, cfg, audio_model.cfg, add_cfg_to_tree=False)
    ...
    model = AudioGPTLoRAModel.restore_from(
        restore_path=cfg.model.restore_from_path,
        trainer=trainer,
