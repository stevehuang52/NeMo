...
from nemo.collections.asr.data.audio_to_multi_label_dataset import (
...
class EncDecMultiClassificationModel(EncDecClassificationModel):
    ...
    def __init__(self, cfg: DictConfig, trainer: Trainer = None):
        ...
        if cfg.get("is_regression_task", False):
            raise ValueError(f"EncDecMultiClassificationModel requires the flag is_regression_task to be set as false")
