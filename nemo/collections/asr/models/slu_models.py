...
from nemo.collections.asr.losses.slu_loss import SeqNLLLoss
...
from nemo.collections.common.losses.smoothed_cross_entropy import SmoothedNLLLoss
...
class SLUIntentSlotBPEModel(ASRModel, ExportableEncDecModel, ASRModuleMixin, ASRBPEMixin):
    ...
    def __init__(self, cfg: DictConfig, trainer=None):
        ...
        self.loss = SmoothedNLLLoss(label_smoothing=0.0)
    ...
    def training_step(self, batch, batch_nb):
        ...
        eos_semantics_mask = get_seq_mask(log_probs, eos_semantics_len)
...
class SLU2ASREncDecBPEModel(EncDecCTCModelBPE):
    def __init__(self, cfg: DictConfig, trainer=None):
        ...
        self.teacher_force_greedy = True
        self.searcher = SequenceGenerator(
            cfg.sequence_generator, self.embedding, self.decoder, self.classifier, self.tokenizer
        )
