...
from nemo.collections.alm.modules.common.audio_text_generation_strategy import (
    END_OF_SEQ,
...
def sample_sequence_batch(
    ...
    with torch.no_grad():
        ...
        maxlen = (
            tokens_to_generate + context_lengths.max().item() + inference_strategy.audio_length_to_add.max().item()
        )
