...
def main(cfg: DictConfig) -> None:
    ...
    if "pretrained" in cfg.model and cfg.model.pretrained:
        model = IntentSlotClassificationModel.restore_from(cfg.model.pretrained)
        model.set_trainer(trainer)
    else:
        # initialize the model using the config file
        model = IntentSlotClassificationModel(cfg.model, trainer=trainer)

    if "test_only" in cfg and cfg.test_only:
        logging.info(
            "================================================================================================"
        )
