...
def main(cfg):
    ...
    pre_trained = EncDecRNNTBPEModel.from_pretrained(cfg.init_from_pretrained_model)
    asr_model.encoder.load_state_dict(pre_trained.encoder.state_dict(), strict=False)
